...
![rayleigh-demo](/assets/rayleigh.webm)


## Mie Scattering
Mie scattering is caused by larger (aerosol) particles and is wavelength independent (red, green, and blue light is scattered the same amount). It causes the region of sky closer to the Sun to appear brighter.

Lets extend \eqref{eq:9} to allow for multiple different sources of scattering. We can redo all the steps we did before to come to the following equation.
...
### Rendering the Sun
We will not use physically based methods to render the Sun in our shader. We will just use the techniques already outlined in this article to create something that looks reasonable.
...
And finally here is the completed shader. The direction of the Sun can be adjusted with the mouse.

<iframe width="640" height="360" frameborder="0" src="https://www.shadertoy.com/embed/Wcs3z4?gui=true&t=10&paused=true&muted=false" allowfullscreen></iframe>
